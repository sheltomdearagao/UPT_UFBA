...
import { Student, Correction, Simulado } from '../../../types';
...
export const StudentDashboardPage: React.FC<StudentDashboardPageProps> = ({ student, corrections, simulados }) => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card>
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Última Média Objetiva</p>
              {latestCorrection ? (
                <p className="text-2xl font-bold text-gray-800 dark:text-gray-200">{latestCorrection.objectiveAverage.toFixed(2)}</p>
              ) : (
        ...
        <Card>
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              {latestCorrection ? (
                <p className="text-2xl font-bold text-gray-800 dark:text-gray-200">{latestCorrection.scores.redacao}</p>
              ) : (
                <p className="text-xl text-gray-600 dark:text-gray-400">N/A</p>
              )}
            </div>
      ...
      <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200">Sua Evolução (Média Geral)</h2>
      <Card>
        {corrections.length > 0 ? (
          <ResponsiveContainer width="100%" height={400}>
            <LineChart data={chartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
              ...
              />
              <Legend />
              <Line type="monotone" dataKey="Média Geral" stroke="#3b82f6" strokeWidth={2} activeDot={{ r: 8 }} />
            </LineChart>
          </ResponsiveContainer>
        ) : (
            <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                <p>Você ainda não completou nenhuma prova.</p>
